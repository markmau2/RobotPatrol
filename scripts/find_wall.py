...
import rospy
import time
from section2.srv import FindWallMessage, FindWallMessageResponse
...
def my_callback(request):
    ...
    response = FindWallMessageResponse()
    response.wallfound = True
    return response # the service Response class, in this case EmptyResponse

def main():
  rospy.init_node('service_Find_Wall') 
  my_service = rospy.Service('/find_wall', FindWallMessage , my_callback) # create the Service called move_bb8_in_square_custom with the defined callback
